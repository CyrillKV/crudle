...
const Post = ({ post, setCurrentId, switchShowModal }) => {
  ...
  return (
    <Card variant='outlined' sx={{p: '1rem 1rem 0 1rem', border:'solid 1px lightblue'}}>
      <CardMedia sx={{height: '14rem'}} component='img' src={post.selectedFile || 'https://user-images.githubusercontent.com/194400/49531010-48dad180-f8b1-11e8-8d89-1e61320e1d82.png'} title={post.title} />
      <div>
